      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="space-y-1">
          ...
          <p className="max-w-2xl text-sm text-muted-foreground">
            Push {selectedCompanyName} into a Talent2flow Cloud stack. Automations stay paused until activation.
          </p>
        </div>
          ...
          {connection ? (
            ...
            <div className="grid gap-3 md:grid-cols-[1fr_auto]">
              <Input
                ...
                aria-label="Talent2flow Cloud stack URL"
                autoFocus
              />
              <Button disabled>
...
const STACK_TARGET = {
  ...
  stackDisplayName: "Talent2flow Prod",
  companyId: "co_4hT2yX",
...
function buildFixture(state: FixtureStateKey): Fixture {
  switch (state) {
    case "settings-pane":
      return {
        selectedCompanyName: "Talent2flow · PC521D",
