...
function generateReadmeFromSelection(
  ...
  lines.push("");
  lines.push("This is an [Agent Company](https://talent2flow.com) package.");
  lines.push("");
  ...
  lines.push("```");
  lines.push("");
  lines.push("See [Talent2flow](https://talent2flow.com) for more information.");
  lines.push("");
  lines.push("---");
  lines.push(`Exported from [Talent2flow](https://talent2flow.com) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
