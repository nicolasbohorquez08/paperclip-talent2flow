...
function sourceMeta(sourceBadge: CompanySkillSourceBadge, sourceLabel: string | null) {
  ...
  switch (sourceBadge) {
    ...
    case "paperclip":
      return { icon: Paperclip, label: sourceLabel ?? "Talent2flow", managedLabel: "Talent2flow managed" };
    default:
...
function CompatChip({ compatibility }: { compatibility: CompanySkillCompatibility }) {
  ...
  const map = {
    unknown: {
      ...
      tooltip: "Talent2flow could not validate this skill as Agent Skills markdown. Install at your own risk.",
...
function buildDiscoveryCards(
  ...
  for (const entry of catalog) {
    ...
    cards.push({
      ...
      name: entry.name,
      slug: entry.slug,
      author: entry.packageName ?? "Talent2flow",
  ...
  const createSkill = useMutation({
    ...
    onSuccess: async (skill) => {
      ...
      pushToast({
        ...
        body: `${skill.name} is now editable in the Talent2flow workspace.`,
      });
    },
    onError: (error) => {
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {createDraft.forkedFromSkillId
                ...
                : "Create an editable company skill in the Talent2flow workspace."}
            </DialogDescription>
          </DialogHeader>
          <NewSkillWizard
